    ...
    grunt.initConfig({
            ...
            js: {
                files: {
                    'public/js/forum.min.js': [
                        ...
                        'public/js/angular-local-storage.min.js',
                        'public/js/angular-sanitize.min.js',
                        'public/js/ngFacebook.js',
                        'public/frontend/**/*.js'
                    ]
                }
            },
        ...
        watch: {
            scripts: {
                ...
                tasks: [
                    'clean:js', 'concat:dev', 'jshint', 'uglify'
                ],
                options: {
                    spawn: false,
                    reload: true
        ...
        clean: {
            js: [
                'public/js/forum.min.js', 'public/js/socket.io.min.js'
            ],
