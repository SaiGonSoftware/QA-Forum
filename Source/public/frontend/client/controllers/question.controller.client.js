...
(function() {
	...
	PostQuestionController.$inject = ['$scope', '$location', 'localStorageService', 'PostQuestionService', 'CategoriesService', 'AutoCompleteService'];

	function PostQuestionController($scope, $location, localStorageService, PostQuestionService, CategoriesService, AutoCompleteService) {
